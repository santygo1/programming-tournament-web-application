...
INSERT INTO tournament(title, text, date, duration_minutes)
VALUES ('Олимпиада по информатике', 'Описание олимпиады по информатике',  '2024-08-15', 180),
       ('Чемпионат по программированию','Описание чемпионата по программированию' ,'2024-11-21', 180),
       ('Турнир "Кодеры будущего"', 'Описание Турнир "Кодеры будущего"', '2024-09-10', 160),
       ('Открытый кубок по алгоритмике', 'Описание открытый кубок по алгоритмике', '2024-10-05', 160),
       ('Чемпионат мира по разработке ПО','Описание чемпионат мира по разработке ПО',  '2024-12-02', 160);
