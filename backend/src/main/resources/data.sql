...
INSERT INTO task (title, category,input_data_format, output_data_format, task_condition)
...
VALUES ('Олимпиада по информатике', 'Описание олимпиады по информатике', 'ML','2024-08-15','2024-08-15'),
       ...
       NULL , '2024-12-02 20:20:00', '2024-10-05 18:20:00'),
    ('Международная олимпиада Innopolis Open – Профиль «Робототехника',
...
INSERT INTO tournament_task(tournament_id, task_id)
VALUES
    (1,1),
    (1,2),
    (3,3),
...
INSERT INTO task (title, task_condition, input_data_format, output_data_format, time_requirements, memory_requirements)
VALUES
